...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_AboutForm_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_AboutForm_t qt_meta_stringdata_AboutForm = {
    {
...
QT_MOC_LITERAL(3, 20, 6)
    ...
    "AboutForm\0accepted\0\0accept\0"
};
...
void AboutForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AboutForm::accepted)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject AboutForm::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_AboutForm.data,
      qt_meta_data_AboutForm,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_AboutForm.stringdata))
